...
class NotebookPage extends StatefulWidget {
  ...
  const NotebookPage({Key? key, required this.accessToken, required this.userEmail}) : super(key: key);
...
class _NotebookPageState extends State<NotebookPage> {
  ...
  Future<void> _loadProducts() async {
    try {
      _products = ProductApiService.getProducts(widget.accessToken, 4);
      await _products;
    } catch (error) {
            ...
            children: products.map<Widget>((product) {
              ...
              return CrudContainer(
                ...
                onDelete: () {
                  setState(() {
                    _products =
                        ProductApiService.getProducts(widget.accessToken, 4);
                  });
                },
              );
            }).toList(),
